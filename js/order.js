...
function fetchOrders() {
  $.getJSON(
    "/EZMartOrderingSystem/api/orderapi.php?action=fetch",
    function (data) {
    ...
    .done(function (response) {
      if (response.success) {
        ...
        if (response.token_invalid) {
          alert(
            "Status updated, but customer notification failed (app not installed)"
          );
  ...
  $.ajax({
    ...
    .done(function (response) {
      ...
      if (response.success) {
        ...
        if (response.token_invalid) {
          alert(
            "Order confirmed, but customer notification failed (app not installed)"
          );
        } else if (response.notification_sent) {
...
function deleteOrder(id, button) {
  ...
  if (confirm("Are you sure you want to delete this order?")) {
    $.post(
      "/EZMartOrderingSystem/api/orderapi.php",
      { action: "delete", id: id },
      function (response) {
